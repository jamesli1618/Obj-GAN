...
def parse_args():
    ...
    parser.add_argument('--NET_G', type=str, default='../data/coco/pretrained/image_ckpt/netG_epoch_0.pth') # 
    ...
    parser.add_argument('--DAMSM_LAMBDA', type=float, default=200.0)
    parser.add_argument('--TXT_LAMBDA', type=float, default=0.1)
    parser.add_argument('--SEG_LAMBDA', type=float, default=0.1)
    parser.add_argument('--LAB_LAMBDA', type=float, default=0.1)
...
if __name__ == "__main__":
    ...
    cfg.TRAIN.SMOOTH.SEG_LAMBDA = args.SEG_LAMBDA
    cfg.TRAIN.SMOOTH.LAB_LAMBDA = args.LAB_LAMBDA
