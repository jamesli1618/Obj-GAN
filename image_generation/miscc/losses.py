...
def G_loss(netsPatD, netsShpD, netObjSSD, netObjLSD, image_encoder, fake_imgs, seg_conditions,
    ...
    for i in range(numDs):
        ...
        errG = nn.BCELoss()(logits, real_labels)
        shp_g_loss = errG * cfg.TRAIN.SMOOTH.SEG_LAMBDA
    ...
    if real_batch_size > 0:
        ...
        if uncond_flag:
            ...
            objss_g_loss += (cond_errG + errG) * cfg.TRAIN.SMOOTH.LAB_LAMBDA
        else:
            objss_g_loss += cond_errG * cfg.TRAIN.SMOOTH.LAB_LAMBDA
    ...
    if real_batch_size > 0:
        ...
        if uncond_flag:
            ...
            objls_g_loss += (cond_errG + errG) * cfg.TRAIN.SMOOTH.LAB_LAMBDA
        else:
            objls_g_loss += cond_errG * cfg.TRAIN.SMOOTH.LAB_LAMBDA
